...
// This 'SELECT' command has been pulled from hoodiecrow/lib/commands/select.js.
// Its only modification is to remove the "SELECT UIDNEXT" return block, which
// has been included (commented out) below.
